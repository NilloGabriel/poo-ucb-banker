...
@NamedQueries({
    ...
    @NamedQuery(name = "Contato.findByOperadora", query = "SELECT c FROM Contato c WHERE c.operadora = :operadora")})
public class Contato implements Serializable {
    ...
    public Contato(Integer id, String numero, String operadora) {
        this.id = id;
        this.numero = numero;
